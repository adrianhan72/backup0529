...
const KO = {
  ...
  employees: {
    ...
    columns: {
      ...
      nationality: '국적 (외국인 선택입력)',
      residence_status: '체류자격 (외국인 선택입력, 법무부 코드)',
      occupation: '직종 (외국인 선택입력, 고용·산재보험 코드)',
      note: '비고',
      created_at: '생성일시',
      updated_at: '수정일시',
    }
  ...
  contracts: {
    ...
    columns: {
      ...
      pay_period_day: '급여 산정기준일',
      pay_day: '급여 지급일',
      pay_method: '임금 지급 방법 (daily=일급/weekly=주급/monthly=월합산)',
      pay_condition: '일급 지급 조건 (same_day=당일/after_n_days=n일 후)',
      pay_after_days: '일급 지급 n일 후 (n)',
      pay_weekday: '주급 지급 요일 (0=일~6=토)',
      pay_period_weekday: '주급 산정기간 시작 요일 (0=일~6=토, null=자동: 지급일 당일까지 1주)',
      pay_period_day_override: '월합산 산정기준일 (개별 편집, null=고객사 설정)',
  ...
  payrolls: {
    ...
    columns: {
      id: '고유식별자',
      employee_id: '직원 ID',
      employee_number: '사번 스냅샷 (급여 저장 당시)',
      company_id: '회사 ID',
      contract_id: '계약 ID',
      pay_year: '급여 연도',
      pay_month: '급여 월',
