...
CREATE TABLE IF NOT EXISTS "contracts" (
    ...
    fixed_ot_pay          REAL,
    fixed_ot_hours        REAL,
    fixed_night_pay       REAL,
    fixed_night_hours     REAL,
    fixed_hol_pay         REAL,
    fixed_hol_hours       REAL,
    probation_months      INTEGER,
    probation_pct         REAL,
    probation_amt         REAL,
    probation_basis       TEXT,
    amended_from          TEXT,
    is_voided_by_amend    INTEGER DEFAULT 0,
    voided_at             TEXT,
    signed_file_name      TEXT,
    signed_file_data      TEXT,
    consent_file_name     TEXT,
    consent_file_data     TEXT,
    ...
    remote_area_pay_type  TEXT,
    car_maintenance       REAL,
    regular_bonus         REAL,
    childcare_allowance   REAL,
    childcare_dependents  INTEGER,
