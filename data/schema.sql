...
CREATE TABLE IF NOT EXISTS employees (
  ...
  created_at          INTEGER,
  updated_at          INTEGER
, is_representative INTEGER DEFAULT 0, bank_name TEXT, bank_account TEXT, expire_date TEXT, tax_dependents INTEGER DEFAULT 0);
...
CREATE INDEX idx_tax_bracket_rows_year ON tax_bracket_rows(year);

CREATE TABLE IF NOT EXISTS tax_brackets (id TEXT PRIMARY KEY, year INTEGER NOT NULL UNIQUE, data TEXT NOT NULL, created_at INTEGER, updated_at INTEGER);
