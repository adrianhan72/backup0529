  ...
  const probSection = isProb ? `
    <div class="doc-section">
      ...
      <div class="doc-probation-box">
        ...
        ? 수습기간은 근속기간에 포함하여 산정합니다.<br>
        <span style="color:#b91c1c;">※ 수습기간 3개월 초과 후 해고 시 근로기준법 제26조에 따라 30일 전 해고예고 또는 30일분 통상임금(해고예고수당)을 지급해야 합니다.</span>
      </div>
    </div>` : '';
        ...
        if(_detail){
          ...
          _detail.innerHTML =
            `<div style="display:flex;justify-content:space-between;border-bottom:1px dashed #fca5a5;padding-bottom:6px;margin-bottom:6px;">
             ...
             <div style="display:flex;justify-content:space-between;border-bottom:1px dashed #fca5a5;padding-bottom:6px;margin-bottom:6px;">
               <span>?? ${_contractYear}년 법정 최저시급</span>
