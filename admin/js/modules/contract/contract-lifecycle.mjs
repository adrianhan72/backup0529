...
export async function saveDraftContract(reason){
  ...
  if(isEditMode){
    ...
    const res = await _w('api')(`../tables/contracts/${editId.contract}`,{method:'PATCH',headers:{'Content-Type':'application/json'},body:bodyJSON});
...
export async function saveContract(){
  ...
  if(isEditMode){
    ...
    await _w('api')(`../tables/contracts/${editId.contract}`,{method:'PUT',headers:{'Content-Type':'application/json'},body:JSON.stringify(body)});
    // ── 직원 정보도 함께 업데이트 ──
